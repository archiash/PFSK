...
<script>
var qa = [
    { question: "จังหวัดที่มีเนื้อที่น้อยที่สุด คือจังหวัดใด", answer: "สมุทรสาคร" },
    { question: "พระที่นั่งเวหาศน์จํารูญ อยู่จังหวัดใด", answer: "พระนครศรีอยุธยา" },
    { question: "งานประเพณี ผีตาโขน จัดที่จังหวัดใด", answer: "เลย" },
    { question: "ชื่อเมืองหลวงของประเทศใดยาวที่สุดในโลก", answer: "ไทย" },
    ...
    { question: "คุณธรรมคือความรู้ เป็นทฤษฎีคลาสสิกของนักคิดชาวกรีกโบราณท่านใดที่มีชื่อเสียง", answer: "โสกราตีส"},
    ...
    { question: "ในเทพนิยายกรีกใครที่ได้มีฉายาเรียกว่าเทพีแห่งสงครามและปัญญา", answer: "เทพีอะธีนา"},
    ...
    { question: "ประเทศไทยทั้งหมดมีกี่จังหวัด", answer: "76"},
    { question: "ช่างแกะสลักท่านใดในยุคพื้นฟูศิลปวิทยาที่สร้างประติมากรรมชายคลาสสิก เดวิด", answer: "มีเกลันเจโล"}
    ,{ question: "ตัวอักษรบนลานจอดเฮลิคอปเตอร์คืออะไร", answer: "H"}
    ,{ question: "จังหวัดใดไม่อยู่ในภาคเหนือ", answer: "เลย"}
    ,{ question: "อวัยวะใดได้ความเสียหายร้ายแรงที่สุดจากแอลกอฮอล์", answer: "ตับ"}
    ,{ question: "ปลาตาเดียว มีกี่ตา", answer: "2"}
    ,{ question: "เมื่อสถาปนาความสัมพันธ์ทางการทูตกับประเทศอื่นสถาบันใดจะมีการจัดตั้งขึ้นในเมืองหลวงของประเทศนั้นๆ", answer: "สถานทูต"}
    ,{ question: "ชื่อเดิมของประเทศไทยคืออะไร", answer: "สยาม"}
    ,{ question: "ดอกไอริสคือดอกไม้ประจำชาติที่เป็นสัญลักษณ์แห่งความรักและมิตรภาพของประเทศใด", answer: "ฝรั่งเศษ"}
    ,{ question: "ประเทศใดที่ได้รับการรับรองเป็นสมาชิกลําดับ 12 ของยูโรโซนจากสหภาพยุโรป", answer: "กรีซ"}
    ,{ question: "แม่น้ำใดถูกขนานนามว่าเป็น แม่น้ำสายหลัก ของคนอินเดีย", answer: "แม่น้ำคงคา"}
    ,{ question: "เทือกเขาแห่งใดยาวที่สุดในโลก", answer: "เทือกเขาแอนดีส"}
    ,{ question: "แสงจันทร์ที่เราเห็นคือ", answer: "แสงอาทิตย์สะท้อนจากดวงจันทร์"}
    ,{ question: "พิธีประกาศรางวัลประจําปีที่ยิ่งใหญ่ที่สุดในอุตสาหกรรมภาพยนตร์คืออะไร", answer: "รางวัลออกสการ์"}
    ,{ question: "อุทยานแห่งขาติศรีสัชนาลัย อยู่จังหวัดใด", answer: "สุโขทัย"}
    ,{ question: "อุทยานแห่งชาติน้ำหนาว อยู่จังหวัดใด", answer: "เพชรบูรณ์"}
    ,{ question: "ผู้ก่อตั้งเว็บไซต์ Facebook คือใคร", answer: "มาร์ก ซักเคอร์เบิร์ก"}
    ,{ question: "จังหวัดใดอยู่เหนือสุดของประเทศไทย", answer: "เชียงราย"}
    ,{ question: "เมืองแห่งทะเลภูเขา สุดหนาวในสยาม ดอกไม้งามสามฤดู ถิ่นที่อยู่อริยสงฆ์ มั่นคงความสะอาด เป็นคำขวัญของจังหวัดใด", answer: "เลย"}
    ,{ question: "ประเทศใดในเอเชียตะวันออกเฉียงใต้ถูกขนานนามว่าเป็น เมืองในสวน", answer: "สิงคโปร์"}
    ,{ question: "กีต้าร์ทั่วไป มีกี่สาย", answer: "6 สาย"}
    ,{ question: "เมืองมะขามหวาน คือจังหวัดใด", answer: "เพชรบูรณ์"}
    ,{ question: "ผู้เขียนของผลงานคลาสสิกด้านจิตวิทยา “จิตวิทยาความฝัน” คือท่วนใด", answer: "ฟร็อยท์"}
    ,{ question: "คำย่อภาษาอังกฤษของระบบกําหนดตําแหน่งบนโลกคืออะไร", answer: "GPS"}
    ,{ question: "ปลาส่วนใหญ่จะไม่กระพริบตา เพราะพวกมันขาดอวัยวะส่วนไหน", answer: "เปลือกตา"}
    ,{ question: "งานวันกาชาดมีครั้งแรกในรัชสมัยใด", answer: "รัชกาลที่ 7"}
    ,{ question: "ประเทศใดให้ความสําคัญมากที่สุดกับการอนุรักษ์น้ำในโลก", answer: "อิสราเอล"}
    ,{ question: "แหล่งผลิตยางพารา น้้ามันปาล์มและมะพร้าวเป็นจํานวนมากที่สุดในโลกคือ", answer: "เอเชียตะวันออกเฉียงใต้"}
    ,{ question: "กีฬาบาสเกตบอลกําเนิดขึ้นจากประเทศใด", answer: "อเมริกา"}
    ,{ question: "น้ำปลา มีรสชาติอะไร", answer: "เค็ม"}
    ,{ question: "เชียงรายมีกี่จังหวัด", answer: "1"}
    ,{ question: "ปิกัสโซ่ มีผลงานภาพวาดที่ได้รับรางวัล สันติภาพระหว่างประเทศ ในช่วงปี 1950 ภาพวาดนี้คือ", answer: "นกพิราบแห่งสันติภาพ"}
    ,{ question: "รสชาติอูมามิของผงชูรสปรุงได้จากกรดกลูตามิก มันถูกค้นพบครั้งแรกในน้ำซุปอะใร", answer: "ซุปสาหร่าย"}
    ,{ question: "แม่น้ำน่าน มีต้นกําเนิดจากจังหวัดใด", answer: "น่าน"}
    ,{ question: "เกาะที่ใหญ่ที่สุดในกรีกและเป็นแหล่งกําเนิดอารยธรรมของกรีกคือเกาะใด", answer: "ครีต"}
    ,{ question: "สถาบันใดที่เป็นชื่อรองว่า เดอะเพนตากอน ในสหรัฐอเมริกา", answer: "กระทรวงกลาโหม"}
    ,{ question: "กำแพงที่ยาวที่สุดในโลกอยู่ที่ประเทศใด", answer: "จีน"}
    ,{ question: "แพลตฟอร์มของการแข่งขันกีฬากระโดดน้ำในโอลิมปิกสูงเท่าไหร", answer: "10 เมตร"}
    ,{ question: "อินซูลินเป็นองค์ประกอบประเภทใด", answer: "โปรตีน"}
    ,{ question: "เมืองขุขันธ์ เป็นชื่อโบราณของจังหวัดใด", answer: "ศรีสะเกษ"}
    ,{ question: "พินอคคีโอคืออะไร", answer: "ไม้"}
    ,{ question: "ร่างกายของสฟิงซ์เป็นส่วนผสมของสัตว์ใด", answer: "สิงโต"}
    ,{ question: "บริษัทของไอรอนแมน ในช่วงแรกก่อนหน้าได้ดำเนินธุรกิจอะไร", answer: "อาวุธ"}
    ,{ question: "มีประกาศใช้พระราชบัญญัตินามสกุลในรัชสมัยใด", answer: "รัชกาลที่ 6"}
    ,{ question: "ในเรื่อง เดอะก็อดฟาเธอร์ พี่น้องคอร์เลโอเนคนไหนเคยเป็นทหาร", answer: "ไมเคิล"}
    ,{ question: "เทพเจ้าองค์ใดถูกขนานนามว่าเป็นเทพเจ้าแห่งสงครามในเทพนิยายกรีก", answer: "แอรีส"}
    ,{ question: "ข้อใดต่อไปนี้ได้จากการย่อยสลายข้าวและพาสต้าที่บริโภคโดยทั่วไป", answer: "กลูโคส"}
    ,{ question: "โอฆะบุรี เป็นชื่อเดิมของจังหวัดอะไร", answer: "พิจิตร"}
    ,{ question: "นักเดินเรือท่านใดที่ได้พิสูจน์ว่าโลกกลม", answer: "แมกแจลแลน"}
    ,{ question: "ประเทศใดได้ชื่อจัดการกับขยะดีที่สุดในโลก", answer: "ญี่ปุ่น"}
    ,{ question: "ภาษาราชการของประเทศอิหร่านคืออะไร", answer: "ภาษาเปอร์เซีย"}
    ,{ question: "โรงเรียนสอนช้างแห่งแรกของโลก อยู่ที่จังหวัดใด", answer: "ลำปาง"}
    ,{ question: "ข้อใดต่อไปนี้เป็นสํานักข่าวของสหรัฐอเมริกา", answer: "Associated Press"}
    ,{ question: "ในเทพตํานาน นอร์ส โลกิ เป็นพี่น้องกับเทพคนใด", answer: "โอดิน"}
    ,{ question: "ตัวเอกในนวนิยายเรื่อง ปีเตอร์ แพน มีชื่อว่าอะไร?", answer: "ปีเตอร์ แพน"}
    ,{ question: "ในประวัติศาสตร์อังกฤษ กษัตริย์องค์เดียวที่ถูกประหารชีวิตต่อหน้าสาธารณชนคือใคร?", answer: "ชาลล์ ที่1"}
    ,{ question: "คำขวัญ เมืองปราสาทหิน ถิ่นภูเขาไฟ เป็นของจังหวัดใด", answer:"บุรีรัมย์"}
    ,{ question: "นายกรัฐมนตรีคนแรกของไทย ชื่ออะไร", answer:"พระยามโนปกรณ์นิติธาดา"}
    ,{ question: "เขื่อนเจ้าพระยา กั้นแม่น้ำเจ้าพระยา อยู่ที่จังหวัดใด", answer:"ชัยนาท"}
    //,{ question: "
    //", answer: ""}
